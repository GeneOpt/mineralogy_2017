...
% for Hh = 3:28  % for the rock
for Hh = 5:28
% for Hh = 3:23    % for the sediment
    ...
    load([folder 'concatenated files\' matNm{Hh}])
    ptclH = struct;
...
%     for the rock
    save([folder 'concatenated files\' matNm{Hh} '.mat'],'isleD','ptclD','ptclH','-append');
