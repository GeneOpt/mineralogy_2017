...
mins = {'blank','Qtz','Ksp','Ab','An25','An50','An75','Mscv','Bti_low','Bti_Mg','Bti_int',...
    ...
    'Fe_Amph','Epd_Zo','Apt','Trml','Zrc','Calg','AlOx','Udf'};

mins_abbv = {'blank','Qtz','Ksp','Plagc','Mscv','Btic',...
    'Kao','Chlc','Mg_Clay','Mg_Si','Ill_Smecc','Cal',...
    'Dolc','Fe_ox_si','Prt','Gyp_Anh','Hlt','Ilmc','Ttn','Lmt','Cpx',...
    'Fe_Amph','Epd_Zo','Apt','Trml','Zrc','Calg','AlOx','Udf'};
...
minsN_abbv = {'blank','Qtz','Ksp','Plag c','Mscv','Bti c','Kao','Chl c','Mg Clay','Mg Si','Ill Smec c','Cal',...
    'Dol','Fe ox si','Prt','Gyp Anh','Hlt','Ilm c','Ttn','Lmt','Cpx',...
    'Fe Amph','Epd Zo','Apt','Trml','Zrc','Calg','AlOx','Udf'}
