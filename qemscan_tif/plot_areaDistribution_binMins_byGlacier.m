...
fOut = 'D:\Code\Summer_2013_data\mineral_data\qemscan_tif\figures_revisedCol\areaDistributions\normalized_by_bin\bins5\non_pdf_noSetYaxis\'
mkdir(fOut)
...
%         [binC,binC_S,yBin,mBin,stdBin,sDat,sBin] = bin_szHist(islD,islD);
