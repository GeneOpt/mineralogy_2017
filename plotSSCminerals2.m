...
{'Chlinoclore '};{'Clinozoisite'};{'Illite/Mscvt.'};...
{'Laumontite  '};{'Montmorill. '};{'Ank./Dolomite'};{'Calcite    '};...
{'Gypsum      '}];
...
GL1SSCminMtx = [GL1_11Jul13_06,...
    GL1_15Jul13_12,Gl1_18Jul13_23,Gl1_18Jul13_31,...
    Gl1_23Jul13_42,Gl1_24Jul13_45,Gl1_23Jul13_42_susp,...
    Gl1_spring,Gl1_13BH10,Gl1_13BH50,Gl1_12_14,...
    Gl1_12_25,Gl1_Ti1301,Gl1_Ti1302];

% f1 = figure('units','normalized','outerposition',[0 0 1 1])
f1 = figure;
axes('position', [ 0.1 0.2 0.8 0.7]);
b = zeros(1,16);
colE = ['k';'k';'k';'k';'k';'k';'k';'k';'k';'k';'k';'r';'k';'r'];
colF =['b';'b';'b';'b';'b';'b';'w';'m';'g';'g';'r';'w';'r';'w'];
mark = ['s';'o';'v';'d';'>';'>';'<';'s';'s';'o';'s';'s';'^';'^'];
...
if i == 10
    colrf = [0 0.5 0]
        ...
        b(i) = plot([1:length(mineralsRe)]+(4/6), reMins, 'marker',mark(i), 'markersize', 12,...
